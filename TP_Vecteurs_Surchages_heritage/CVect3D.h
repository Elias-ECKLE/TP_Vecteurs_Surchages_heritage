...
public:
	...
	//Methodes :
			...
			//BUT : afficher directement avec un cour les coordonnées du vecteur
			//ENTREE : le flux ostream et le vecteur concerné
			//SORTIE: le flux 
			friend ostream& operator<<(ostream& os, const CVect3D&);
